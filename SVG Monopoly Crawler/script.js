...
const board = [
  ...
  // utility function creating the svg for the properties
  ...
  // utility function creating the svg for the other sections
  ...
  // utility function returning the x and y position of a section in the overall board
